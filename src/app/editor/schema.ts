...
const SCHEMAS: Record<SectionKey, FieldSchema[]> = {
  ...
  pricing: [
    ...
    { key: 'title', label: 'العنوان', type: 'text' },
    { key: 'intro', label: 'المقدّمة', type: 'textarea' },
    { key: 'monthlyLabel', label: 'زر شهري', type: 'text' },
    { key: 'annualLabel', label: 'زر سنوي', type: 'text' },
    { key: 'saveBadge', label: 'شارة التوفير', type: 'text' },
    { key: 'featuredBadge', label: 'شارة الأكثر شيوعاً', type: 'text' },
    { key: 'perYear', label: 'لاحقة السعر السنوي', type: 'text' },
    { key: 'perMonth', label: 'لاحقة السعر الشهري', type: 'text' },
    { key: 'customPrice', label: 'نص "حسب الطلب"', type: 'text' },
    { key: 'footnotePre', label: 'نص أسفل (قبل الرابط)', type: 'text' },
    { key: 'footnoteLink', label: 'نص الرابط', type: 'text' },
    { key: 'footnotePost', label: 'نص أسفل (بعد الرابط)', type: 'text' },
    {
      key: 'plans', label: 'الباقات', type: 'objectlist', itemLabel: 'باقة',
      fields: [
        { key: 'name', label: 'الاسم', type: 'text' },
        { key: 'tagline', label: 'الوصف المختصر', type: 'text' },
        { key: 'monthly', label: 'السعر الشهري (اتركه فارغاً = حسب الطلب)', type: 'number', nullable: true },
        { key: 'annual', label: 'السعر السنوي (اتركه فارغاً = حسب الطلب)', type: 'number', nullable: true },
        { key: 'featured', label: 'باقة مميّزة؟', type: 'boolean' },
        { key: 'cta', label: 'نص الزر', type: 'text' },
        { key: 'features', label: 'المزايا', type: 'stringlist', itemType: 'text', itemLabel: 'ميزة' },
      ],
    },
  ],
  faq: [
